...
class AMapComplete extends Component {
    ...
    render(){
        const {singleShop, modalState, editState,allState, shopAddress} = this.props
        return (
            <div>
                <Input type="text" id="keyword" disabled={this.props.editState}  style={{ width: '100%' }} onChange={this.handleChange.bind(this)}/>
